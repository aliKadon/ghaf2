                          ...
                          _onBoardingContent(
                              SubscriptionObject(
                                  ...
                                  [
                                    ...
                                    '${AppLocalizations.of(context)!.monthly_payment} ${sellerPlan[0]['priceAmount']} ${AppLocalizations.of(context)!.monthly_payment_tier_1_2} ${sellerPlan[0]['setUpCost']} ${AppLocalizations.of(context)!.monthly_payment_tier_1_3}',
                                    '${AppLocalizations.of(context)!.otherwise} ${sellerPlan[3]['priceAmount']}',
                          ...
                          _onBoardingContent(
                              SubscriptionObject(
                                  ...
                                  [
                                    ...
                                    '${AppLocalizations.of(context)!.which}',
                                    '${AppLocalizations.of(context)!.connect}',
                                    '${AppLocalizations.of(context)!.fees} ${sellerPlan[1]['priceAmount']} ${AppLocalizations.of(context)!.fees_tier_2_2} ${sellerPlan[1]['setUpCost']} ${AppLocalizations.of(context)!.fees_tier_2_3}',
                                    '${AppLocalizations.of(context)!.otherwise} ${sellerPlan[3]['priceAmount']}',
                          ...
                          _onBoardingContent(
                              SubscriptionObject(
                                  ...
                                  [
                                    ...
                                    '${AppLocalizations.of(context)!.connect}',
                                    '${AppLocalizations.of(context)!.monthly_payment2} ${sellerPlan[2]['priceAmount']} ${AppLocalizations.of(context)!.monthly_payment2_tier_3_2} ${sellerPlan[2]['setUpCost']} ${AppLocalizations.of(context)!.monthly_payment2_tier_3_3} ${sellerPlan[3]['priceAmount']}',
                                  ]),
                              _currentPageIndex,
                              '${sellerPlan[2]['id']}',
                              '${sellerPlan[3]['id']}',
