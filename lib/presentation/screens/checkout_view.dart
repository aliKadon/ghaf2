...
class _CheckOutViewState extends State<CheckOutView> {
  ...
  void initState() {
    ...
    Provider.of<ProductProvider>(context, listen: false).getRedeemPoints().then(
  ...
  Widget build(BuildContext context) {
    ...
    // print(widget.order);
    var redeemPoints = Provider.of<ProductProvider>(context).redeemsPoints;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                              ...
                              itemCount:
                                  widget.order.availableDeliveryMethod.length,
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          widget.order.availableDeliveryMethod[
                                              index]['methodName'],
                                      ...
                                      if (isSwitchedPayLater) {
                                        setState(() {
                                          payLater = widget.order
                                              .orderDetails['canPayLaterValue'];
                                        });
                                      } else {
                                        setState(() {
                                          payLater = widget.order.orderDetails[
                                              'totalCostForItems'];
                                        });
                                      }
                              ...
                              if (_checkData(deleveryName)) {
                                Navigator.of(context)
                                  ...
                                  'deliveryPoint': widget
                                      .order.orderDetails['deliveryPoint'],
                                  'statusName':
                                      widget.order.orderDetails['statusName'],
                                  'orderId': widget.order.orderDetails['id'],
                                  'item': widget.order.orderDetails['items'][0]
                                      ['id'],
                                  'deliveryMethodId': deleveryMethod,
                                  'date': Helpers.formatDate(dateTosend)
                                          .toString() ??
                                      '',
                                  'address': myAddress ?? '',
                                  'reedem': isSwitched,
