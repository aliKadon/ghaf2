...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  void initState() {
    ...
    Provider.of<ProductProvider>(context, listen: false)
        ...
        .then((value) => getColorIcon(
            Provider.of<ProductProvider>(context, listen: false)
                .orderById['statusName']))
        .then((value) => getTextSetuaition(
            Provider.of<ProductProvider>(context, listen: false)
                .orderById['statusName']))
        .then((value) => Provider.of<ProductProvider>(context, listen: false).getDurationGoogleMap(
              LatOne: double.parse(
                  Provider.of<ProductProvider>(context, listen: false)
                      .orderById['deliveryPoint']['altitude']),
              LonOne: double.parse(
  ...
  Widget build(BuildContext context) {
    ...
    var order = Provider.of<ProductProvider>(context).unpaidOrder;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              orderById1['canPayLaterValue'] == null ? Container() : Visibility(
                                visible: true,
                                child: Row(
                                  children: [
                                    Text(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(onPressed: (){}, child: Column(
                            children: [
                              Icon(Icons.phone),
                              Text(AppLocalizations.of(context)!.call_Store,style: TextStyle(fontSize: 10),)
                            ],
                          )),
                        ),
                        SizedBox(
